...
public class CancelledFragment extends Fragment {
    ...
    private void addBookingData(final RecyclerView recyclerView, String access_key, String partner_id, String restaurant){
        ...
        Call<List<BookingModel>> call = bookingClient.getBookingData(access_key, partner_id, restaurant, "Canceled");
        call.enqueue(new Callback<List<BookingModel>>() {
            ...
            public void onResponse(Call<List<BookingModel>> call, Response<List<BookingModel>> response) {
                ...
                for (int i=0; i < response.body().size(); i++){
                    String body = "<b> " + response.body().get(i).getGuest_name()  + "</b> 's Booking is has been canceled. Kindly make you accept bookings inorder to maintain the hospitality rank.";
                    pendingBookings.add(new NotificationsModel(response.body().get(i).getBooking_id(), Html.fromHtml(body).toString(), "Ca"));
                }
                    ...
                    public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent e) {
                        ...
                        if(childView != null && gestureDetector.onTouchEvent(e)) {
                            ...
                            String phase_ = phase.getText().toString();
                                Toast.makeText(getContext(), "This booking has been canceled.", Toast.LENGTH_SHORT).show();
                        }
                        return false;
                    }
